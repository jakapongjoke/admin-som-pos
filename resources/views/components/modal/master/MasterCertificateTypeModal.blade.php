...
<!-- Modal -->
<div class="modal fade" id="MasterCertificateTypeModal" tabindex="-1" role="dialog" aria-labelledby="MasterCertificateTypeModal" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">CREATE CERTIFICATE TYPE MASTER</h5>
      ...
      <div class="modal-body">
        ...
        <input type="hidden" class="form-control master_type" id="master_type" name="master_type" value="master_certificate_type"  >
