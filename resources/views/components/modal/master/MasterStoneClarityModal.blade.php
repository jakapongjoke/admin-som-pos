...
<!-- Modal -->
<div class="modal fade" id="MasterStoneClarityModal" tabindex="-1" role="dialog" aria-labelledby="MasterStoneClarityModal" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="hidden" class="form-control master_type" id="master_type" name="master_type" value="master_stone_clarity"  >
