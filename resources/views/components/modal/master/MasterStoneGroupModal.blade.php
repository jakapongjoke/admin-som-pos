...
<!-- Modal -->
<div class="modal fade" id="MasterStoneGroupModal" tabindex="-1" role="dialog" aria-labelledby="MasterStoneGroupModal" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">CREATE STONE GROUP MASTER</h5>
