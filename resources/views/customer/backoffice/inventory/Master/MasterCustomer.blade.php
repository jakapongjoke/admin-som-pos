...
<script>
    ...
    let tableOptions = {
            ...
            updateRoute:"api/master/master-customer",
            deleteRoute:"api/master/master-customer",
            ...
            dataField : {
                ...
                numberVailidateField:["citizen_id","phone_number","poscode"],
                numberCountValidate:[13,10,6],
                emailValidateField:["email"],
                specialCharFilterField:['first_name'],
                textVailidateField:[],
                floatVailidateField:[],
                options:{
            ...
            message:{
                ...
                create:{
                    ...
                    confirmText : "Do you want to create this master customer ?",
                    doneHeading : "Successful",
                    doneText : "Save  Master Successful",
                },
                edit:{
                     confirmHeading:"Edit",
                    confirmText : "Do you want to change master customer ?",
                    doneHeading : "Successful",
                ...
                delete:{
                    ...
                    confirmText : "Do you want to delete this master customer  ?",
                    doneHeading : "Successful",
