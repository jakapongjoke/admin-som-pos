...
class MasterCustomerSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $name = ["ณัฐวุฒิ", "วิชัย", "อมรพงษ์", "พัชรพล", "ณิชา", "เดือนรุ่ง", "ปิยพร", "สุนิตา", "ประภา", "สุรศักดิ์", "อรุณี", "สมิตา", "สิริพร", "ธิดารัตน์", "ชนิดา", "เอกวินท์", "วิลาวัลย์", "เมธาวี", "รัตนดา", "กันต์ภพ", "สิรินทร์",    "นิรุตติ์",    "วีระ",    "นิพนธ์",    "สุพรรณ",    "เยาวพิชัย",    "รัญชน์",    "พงษ์เทพ",    "วรพจน์",    "ณัฏฐ์",    "กิตติ",    "พิสุทธิ์",    "อัศวพงศ์",    "วิชัย",    "ปฏิภาณ",    "เมธา",    "ประสิทธิ์",    "จิรายุ",    "เพ็ญพิชญ์",    "อรวรรณ"];
        $lastname = [  "วงศ์วิไล",  "ศรีสุนทร",  "ทองเนียม",  "ศรีประเสริฐ",  "วงศ์สว่างคำ",  "สมบูรณ์ศรี",  "ช่างชุ่ย",  "ศรีโชคดี",  "สุนทรเวช",  "กุลเดชะ",  "บุญศรี",  "ศรีสุวรรณ",  "รัตนสุดา",  "ธนสุวรรณ",  "ธนสุข",  "พุฒิพงษ์",  "อมรศรี",  "สุทธิชัย",  "พิมพ์ชนก",  "วิรัตน์ศรี","สุขแสน","ศรีวิชัย","จันทร์สว่าง","บุญมี","รักษ์ทิพย์","วิไล","สุขเกษม","แสงสุวรรณ","จินดา","ชื่นชม","เอื้อเฟื้อ","ช่างชุบ","เกิดใหม่","คำนึง","เพ็ชรสุธา","สมเด็จ","ตันติ","ประดู่","หงษ์เจริญ","ชุมพล"];
...
try{
    ...
    $id =   DB::table('ananta_master_code')->insertGetId([
        ...
        'master_description' =>  "master_account_customer ".$cfirstname."@ ".$citydata['name']." Detail ",
        'master_price' => 0,
